...
export const WEEKS: Week[] = [
  ...
  },
  {
    ...
    days: [
      { d: 'mon', date: '2026-08-31', type: 'REST',    title: 'Rest + Chest/Back PM', gym: 'Chest/Back', workoutId: 'chestback' },
      { d: 'tue', date: '2026-09-01', type: 'LONG',    title: 'LONGEST RUN — 32 km · 8 km @ MP',             km: 32, pace: 'easy → 5:41', gym: 'Legs (light)', workoutId: 'legs', notes: '24 km easy + 8 km @ MP. FULL race fueling rehearsal: 1 gel every 30 min, electrolytes throughout, race kit if possible. Legs light in the PM, or skip them.' },
      { d: 'wed', date: '2026-09-02', type: 'EASY',    title: 'Easy 10 km',                                   km: 10, pace: '6:30–7:00', gym: 'Shoulders/Arms', workoutId: 'shouldersarms' },
      { d: 'thu', date: '2026-09-03', type: 'EASY',    title: 'Easy 8 km · shift day',                        km: 8,  pace: '6:30–7:00', notes: '7 h standing shift. Keep it genuinely easy.' },
      { d: 'fri', date: '2026-09-04', type: 'REST',    title: 'Rest + Chest/Back PM · shift day', gym: 'Chest/Back', workoutId: 'chestback' },
      { d: 'sat', date: '2026-09-05', type: 'EASY',    title: 'Easy 8 km + 6×100m strides',                   km: 8,  pace: '6:30–7:00', strides: '6×100m', gym: 'Shoulders/Arms', workoutId: 'shouldersarms', notes: 'No workout — peak week, and there is a game tomorrow.' },
      { d: 'sun', date: '2026-09-06', type: 'GAME',    title: 'Match 15:00 · Deniliquin Wanderers SC (H)', duration: 90, fixture: { kickoff: '15:00', opponent: 'Deniliquin Wanderers SC', venue: 'Chewton Soldiers Memorial Park Pitch 1', homeAway: 'home', confirmed: true }, notes: 'R19. Final fixture before race day — no games from here on.' },
    ],
  },
  {
    ...
    days: [
      { d: 'mon', date: '2026-09-07', type: 'REST',    title: 'Rest + Chest/Back PM', gym: 'Chest/Back', workoutId: 'chestback' },
      { d: 'tue', date: '2026-09-08', type: 'LONG',    title: 'Long 22 km easy · cutback',                   km: 22, pace: '6:30–7:00', gym: 'Legs', workoutId: 'legs', notes: 'Relaxed, conversational throughout.' },
      { d: 'wed', date: '2026-09-09', type: 'EASY',    title: 'Easy 9 km',                                   km: 9,  pace: '6:30–7:00', gym: 'Shoulders/Arms', workoutId: 'shouldersarms' },
      { d: 'thu', date: '2026-09-10', type: 'EASY',    title: 'Easy 7 km · shift day',                       km: 7,  pace: '6:30–7:00', notes: '7 h standing shift. Keep it genuinely easy.' },
      { d: 'fri', date: '2026-09-11', type: 'REST',    title: 'Rest + Chest/Back PM · shift day', gym: 'Chest/Back', workoutId: 'chestback' },
      { d: 'sat', date: '2026-09-12', type: 'WORKOUT', title: '4 km @ MP block',                             km: 10, gym: 'Shoulders/Arms', workoutId: 'shouldersarms', notes: '4 km easy + 4 km @ MP (5:41) + 2 km easy.', chartPace: { category: 'marathonPace', secPerKm: 341 } },
  ...
  // ──────── PHASE 4 — SHARPEN + TAPER ────────
  {
    ...
    days: [
      { d: 'mon', date: '2026-09-14', type: 'REST',    title: 'Rest + Chest/Back PM', gym: 'Chest/Back', workoutId: 'chestback' },
      { d: 'tue', date: '2026-09-15', type: 'LONG',    title: 'Dress Rehearsal Long 28 km · 10 km @ MP',     km: 28, pace: 'easy → 5:41', gym: 'Legs', workoutId: 'legs', notes: '18 km easy + 10 km @ MP. Practice every race detail — fueling, kit, breakfast timing.' },
      ...
      { d: 'sat', date: '2026-09-19', type: 'WORKOUT', title: '5×1.5km @ sub-T (5:25–5:35)',                  km: 11, gym: 'Shoulders/Arms', workoutId: 'shouldersarms', notes: '2 km WU · 5×1.5km @ 5:25–5:35/km · 2 min jog rec · 1 km CD.', chartPace: { category: 'subThreshold', secPerKm: 330 } },
