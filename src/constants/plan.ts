...
export const WEEKS: Week[] = [
  ...
  },
  {
    ...
    days: [
      { d: 'mon', date: '2026-09-07', type: 'REST',    title: 'Rest + Chest/Back PM', gym: 'Chest/Back', workoutId: 'chestback', notes: 'Upper body only. Legs come back tomorrow, light, and only if the week has been symptom-free.' },
      { d: 'tue', date: '2026-09-08', type: 'LONG',    title: 'Long 18 km · all easy',                        km: 18, pace: '6:30–7:00', gym: 'Legs (light)', workoutId: 'legs', notes: 'First real long run back. Entirely easy — no MP, no finishing surge, no proving anything. Fuel it properly anyway (1 gel every 35 min) so the 32 km in a week is not the first time your gut sees race fueling again. Legs return in the PM at half your usual load, full range, and stop the movement at the first pull — skip them outright if the run left anything talking.' },
      { d: 'wed', date: '2026-09-09', type: 'EASY',    title: 'Easy 10 km + 6×100m strides',                  km: 10, pace: '6:30–7:00', strides: '6×100m', gym: 'Shoulders/Arms', workoutId: 'shouldersarms', notes: 'Strides are the first fast running the quad sees. Smooth accelerations, full recovery, stop the set early if anything grabs.' },
      { d: 'thu', date: '2026-09-10', type: 'EASY',    title: 'Easy 8 km · shift day',                        km: 8,  pace: '6:30–7:00', notes: '7 h standing shift. Keep it genuinely easy.' },
      { d: 'fri', date: '2026-09-11', type: 'REST',    title: 'Rest + Chest/Back PM · shift day', gym: 'Chest/Back', workoutId: 'chestback' },
      { d: 'sat', date: '2026-09-12', type: 'WORKOUT', title: 'Gate session — 4 km @ MP block',               km: 10, pace: 'easy → 5:41', gym: 'Shoulders/Arms', workoutId: 'shouldersarms', notes: '4 km easy + 4 km @ MP (5:41) + 2 km easy. This is the gate for Tuesday. Four kilometres at 5:41 should feel rhythmic and unremarkable. If it does, the 32 km is on as written; if it does not, Tuesday becomes 28 km with 6 km @ MP.', chartPace: { category: 'marathonPace', secPerKm: 341 } },
      { d: 'sun', date: '2026-09-13', type: 'REST',    title: 'Full rest · no fixture', notes: 'Season fixtures end 2026-09-06. Full rest day.' },
    ],
  },
