...
export const WEEKS: Week[] = [
  ...
  },
  {
    ...
    days: [
      ...
      { d: 'fri', date: '2026-08-14', type: 'REST',    title: 'Rest + Leg Day (light) PM', gym: 'Legs (light)', workoutId: 'legs' },
      { d: 'sat', date: '2026-08-15', type: 'EASY',    title: 'Easy 8 km + Chest/Back (light) PM',              km: 8,  pace: '6:30–7:00', gym: 'Chest/Back (light)', workoutId: 'chestback' },
      { d: 'sun', date: '2026-08-16', type: 'REST',    title: 'Rest · assess + Shoulders/Arms (light) PM', gym: 'Shoulders/Arms (light)', workoutId: 'shouldersarms' },
    ],
  },
  // ──────── PHASE 3 — MARATHON-SPECIFIC ────────
  {
    ...
    days: [
      ...
      { d: 'thu', date: '2026-08-20', type: 'WORKOUT', title: '6×1km @ T (5:05–5:15)',                        km: 10, notes: '2 km WU · 6×1km @ 5:05–5:15/km · 90s jog rec · 1 km CD.', chartPace: { category: 'threshold', secPerKm: 310 } },
      { d: 'fri', date: '2026-08-21', type: 'REST',    title: 'Rest + Leg Day PM', gym: 'Legs', workoutId: 'legs' },
      { d: 'sat', date: '2026-08-22', type: 'EASY',    title: 'Moderate 11 km — 4 km @ MP + strides + Chest/Back PM', km: 11, pace: 'easy → 5:41', gym: 'Chest/Back', workoutId: 'chestback' },
      { d: 'sun', date: '2026-08-23', type: 'REST',    title: 'Rest + Shoulders/Arms PM', gym: 'Shoulders/Arms', workoutId: 'shouldersarms' },
    ],
  },
  {
    ...
    days: [
      ...
      { d: 'thu', date: '2026-08-27', type: 'WORKOUT', title: '3×3km @ sub-T (5:15–5:25)',                   km: 12, notes: '2 km WU · 3×3km @ 5:15–5:25/km · 3 min jog rec · 1 km CD.', chartPace: { category: 'subThreshold', secPerKm: 320 } },
      { d: 'fri', date: '2026-08-28', type: 'REST',    title: 'Rest + Leg Day PM', gym: 'Legs', workoutId: 'legs' },
      { d: 'sat', date: '2026-08-29', type: 'EASY',    title: 'Moderate 10 km — 4 km @ MP + Chest/Back PM',     km: 10, pace: 'easy → 5:41', gym: 'Chest/Back', workoutId: 'chestback' },
      { d: 'sun', date: '2026-08-30', type: 'REST',    title: 'Rest + Shoulders/Arms PM', gym: 'Shoulders/Arms', workoutId: 'shouldersarms' },
    ],
  },
  {
    ...
    days: [
      ...
      { d: 'thu', date: '2026-09-03', type: 'WORKOUT', title: '5×1.5km @ T (5:00–5:10)',                      km: 12, notes: '2 km WU · 5×1.5km @ 5:00–5:10/km · 90s jog rec · 1 km CD.', chartPace: { category: 'threshold', secPerKm: 305 } },
      { d: 'fri', date: '2026-09-04', type: 'REST',    title: 'Rest + Leg Day PM', gym: 'Legs', workoutId: 'legs' },
      { d: 'sat', date: '2026-09-05', type: 'EASY',    title: 'Moderate 11 km — 4 km @ MP + strides + Chest/Back PM', km: 11, pace: 'easy → 5:41', gym: 'Chest/Back', workoutId: 'chestback' },
      { d: 'sun', date: '2026-09-06', type: 'REST',    title: 'Rest + Shoulders/Arms PM', gym: 'Shoulders/Arms', workoutId: 'shouldersarms' },
    ],
  },
  {
    ...
    days: [
      ...
      { d: 'thu', date: '2026-09-10', type: 'WORKOUT', title: '4 km @ MP block',                             km: 10, notes: '4 km easy + 4 km @ MP + 2 km easy.', chartPace: { category: 'marathonPace', secPerKm: 341 } },
      { d: 'fri', date: '2026-09-11', type: 'REST',    title: 'Rest + Leg Day (light) PM', gym: 'Legs (light)', workoutId: 'legs' },
      { d: 'sat', date: '2026-09-12', type: 'EASY',    title: 'Easy 7 km + 6×100m strides + Chest/Back (light) PM', km: 7, pace: '6:30–7:00', strides: '6×100m', gym: 'Chest/Back (light)', workoutId: 'chestback' },
      { d: 'sun', date: '2026-09-13', type: 'REST',    title: 'Rest + Shoulders/Arms (light) PM', gym: 'Shoulders/Arms (light)', workoutId: 'shouldersarms' },
    ],
  },
  // ──────── PHASE 4 — SHARPEN + TAPER ────────
  {
    ...
    days: [
      ...
      { d: 'thu', date: '2026-09-17', type: 'WORKOUT', title: '8×800m @ T (~4:00–4:05/rep · 5:00–5:06/km)',   km: 11, notes: '2 km WU · 8×800m @ ~4:00–4:05 per rep (5:00–5:06/km) · 90s jog rec · 1 km CD.', chartPace: { category: 'threshold', secPerKm: 303 } },
      { d: 'fri', date: '2026-09-18', type: 'REST',    title: 'Rest + Leg Day PM', gym: 'Legs', workoutId: 'legs' },
      { d: 'sat', date: '2026-09-19', type: 'EASY',    title: '10 km — 5 km @ MP + Chest/Back PM',              km: 10, pace: 'easy → 5:41', gym: 'Chest/Back', workoutId: 'chestback' },
      { d: 'sun', date: '2026-09-20', type: 'REST',    title: 'Rest + Shoulders/Arms PM', gym: 'Shoulders/Arms', workoutId: 'shouldersarms' },
    ],
  },
  {
    ...
    days: [
      ...
      { d: 'thu', date: '2026-09-24', type: 'WORKOUT', title: '4×1km @ T (5:00–5:10) + 4×400m @ CV (~1:55)',  km: 10, notes: '2 km WU · 4×1km @ 5:00–5:10/km · 4×400m @ CV (~1:55) · 90s/60s rec · 1 km CD.', chartPace: { category: 'threshold', secPerKm: 305 } },
      { d: 'fri', date: '2026-09-25', type: 'REST',    title: 'Rest + Leg Day PM', gym: 'Legs', workoutId: 'legs' },
      { d: 'sat', date: '2026-09-26', type: 'EASY',    title: '9 km — 3 km @ MP + Chest/Back PM',               km: 9,  pace: 'easy → 5:41', gym: 'Chest/Back', workoutId: 'chestback' },
      { d: 'sun', date: '2026-09-27', type: 'REST',    title: 'Rest + Shoulders/Arms PM', gym: 'Shoulders/Arms', workoutId: 'shouldersarms' },
    ],
  },
  {
    ...
    days: [
      ...
      { d: 'thu', date: '2026-10-01', type: 'WORKOUT', title: '5×1km @ MP + 5×200m @ CV',                    km: 9,  notes: '2 km WU · 5×1km @ MP (5:41) · 5×200m @ CV (~50s) · 60s rec · 1 km CD.', chartPace: { category: 'marathonPace', secPerKm: 341 } },
      { d: 'fri', date: '2026-10-02', type: 'REST',    title: 'Rest + Leg Day (light) PM', gym: 'Legs (light)', workoutId: 'legs' },
      { d: 'sat', date: '2026-10-03', type: 'EASY',    title: 'Easy 6 km + 6×100m strides + Chest/Back (light) PM', km: 6, pace: '6:30–7:00', strides: '6×100m', gym: 'Chest/Back (light)', workoutId: 'chestback' },
      { d: 'sun', date: '2026-10-04', type: 'REST',    title: 'Rest + Shoulders/Arms (light) PM', gym: 'Shoulders/Arms (light)', workoutId: 'shouldersarms' },
    ],
  },
  {
